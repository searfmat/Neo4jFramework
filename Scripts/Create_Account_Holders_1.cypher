...
CREATE (creditCard4:CreditCard {
			AccountNumber: "1234567999123456",
			Limit: 500000000000000000, Balance: 789789789789.23,
			ExpirationDate: "01-29",
			SecurityCode: "321" })<-[:HAS_CREDITCARD]-(accountHolder4)

// Create Bank Account and connect 1 account holder
CREATE (bankAccount4:BankAccount {
			AccountNumber: "9995678901234567",
			Balance: 789789789789.23 })<-[:HAS_BANKACCOUNT]-(accountHolder4)
